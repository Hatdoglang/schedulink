        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-semibold mb-4">Welcome, {{ Auth::user()->full_name ?? Auth::user()->email }}!</h3>
                    ...
                    <div class="mb-4">
                        <p class="text-gray-600">Your role: <span class="font-semibold text-blue-600">{{ $userRole }}</span></p>
                    </div>
