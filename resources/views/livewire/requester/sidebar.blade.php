        ...
        <ul class="nav flex-column px-2">
            ...
            <li class="nav-item mb-1">
                <a href="{{ route('requester.dashboard') }}"
                    class="nav-link d-flex align-items-center gap-2 rounded px-3 py-2 transition
                       {{ request()->routeIs('requester.dashboard') ? 'bg-primary text-white fw-semibold' : 'text-dark hover-bg-light' }}">
            ...
            <li class="nav-item mb-1">
                <a href="{{ route('requester.bookings') }}"
                    class="nav-link d-flex align-items-center gap-2 rounded px-3 py-2 transition
                       {{ request()->routeIs('requester.bookings') ? 'bg-primary text-white fw-semibold' : 'text-dark hover-bg-light' }}">
