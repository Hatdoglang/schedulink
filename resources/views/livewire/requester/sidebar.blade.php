<aside class="position-fixed top-16 start-0 vh-100 bg-white border-end shadow-sm d-flex flex-column" style="width: 250px; z-index: 60;">
    ...
    <!-- Menu Label -->
    <div class="px-4 pt-3 text-muted fw-semibold small">
        MENU
    </div>
    ...
    <nav class="flex-grow-1 mt-2">
        <ul class="nav flex-column px-2">
            ...
            <li class="nav-item">
                <a href="#"
                   class="nav-link d-flex align-items-center rounded px-3 py-2 text-dark">
