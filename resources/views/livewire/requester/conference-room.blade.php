<div class="p-4">
    <div class="mb-4">
        ...
        <input type="date" id="date" wire:model="selectedDate"
            class="border rounded px-3 py-1 text-sm shadow focus:ring-2 focus:ring-blue-200 focus:outline-none" />
    </div>
                    ...
                    <div class="bg-white border rounded-lg shadow p-4 w-64">
                        ...
                        @forelse ($room->bookings as $booking)
                            ...
                            <div class="border p-2 mb-2 rounded {{ $eventBg }}">
                                ...
                                <span class="inline-block mt-1 {{ $statusColor['text'] }} {{ $statusColor['bg'] }} px-2 py-0.5 text-xs rounded">
