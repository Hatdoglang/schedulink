<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 w-full fixed top-0 left-0 z-40">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center space-x-8">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="/requester/dashboard" wire:navigate>
                ...
                <div class="hidden sm:flex space-x-8">
                    <x-nav-link href="/requester/dashboard" :active="request()->is('requester/dashboard')" wire:navigate>
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>
            </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition">
                            <div x-data="{{ json_encode(['name' => auth()->user()->full_name]) }}"
                                 x-text="name"
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="/requester/dashboard" :active="request()->is('requester/dashboard')" wire:navigate>
                {{ __('Dashboard') }}
