...
<div wire:ignore.self class="modal fade" id="staffDetailsModal" tabindex="-1" aria-labelledby="staffDetailsModalLabel" aria-hidden="true">
            ...
            @if ($selectedBooking)
                ...
                <div class="modal-body">
                    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-2 row"><label class="col-5 fw-semibold">Date:</label>
                                <div class="col-7">{{ \Carbon\Carbon::parse($selectedBooking->scheduled_date)->format('M d, Y') }}</div>
                            </div>
                    ...
                    <div class="modal-footer justify-content-end">
                        <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#vehicleAllocationModal">
                            Allocate Vehicle
                        </button>
                    </div>
                @else
