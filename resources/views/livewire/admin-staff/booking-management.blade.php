            ...
            <div class="col-md-auto d-flex align-items-center">
                <div class="dropdown me-3">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="statusDropdown">
                        <li><a class="dropdown-item {{ request('status') === null ? 'active' : '' }}" href="{{ url()->current() }}">All</a></li>
                                        ...
                                        <td class="pe-4 text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <button class="dropdown-item" wire:click="viewBookingDetails({{ $booking->id }})">
                                                            View Details
                                                        </button>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('admin-staff.bookings.print', $booking->id) }}"
                                                            target="_blank">
